...
const UpdateTask = ({ show, setShow,id ,setTasks }) => {
    ...
    async function handleUpdate(){
        const res=await axios.put(`http://localhost:4000/updateTask/${id}`,taskDetails);
        console.log(res)
        if(res.data.success){
  ...
  return (
    ...
    <Toaster />
      <div className="border border-gray-500 rounded-lg transition-shadow shadow-gray-200 w-[30%] p-2 px-6 m-auto my-40">
        ...
        <h1 className="text-xl text-center my-2">Update Task</h1>
        <input
          type="text"
